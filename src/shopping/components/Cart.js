...
class Cart extends Component {
    ...
    handleChangeProductNumber(cid, e) {
                    ...
                    carts.map(product => (
                        <div className="cart-row" key={product.id}>
                            ...
                            <div className="cart-quantity cart-column">
                                <input className="cart-quantity-input" type="number" value={product.count} onChange={(e) => this.handleChangeProductNumber(product.id, e)}/>
